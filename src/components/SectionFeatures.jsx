function SectionFeatures(){
    return <section className="section-features js--section-features" id="features">
    <div className="row">
        <h2>Get food fast — not fast food.</h2>
        <p className="feature-text">Hello, we’re Omnifood, your new premium food delivery service. We know you’re always busy. No time for cooking. So let us take care of that, we’re really good at it, we promise!</p>
    </div>
    <div className="row js--wp-1" >
        ...
        <div className="col span-1-of-4 box">
            <i className="ion-android-time icon-big"></i>
        ...
        <div className="col span-1-of-4 box">
             <i className="ion-ios-nutrition icon-big"></i>
            <h3>100% organic</h3>
        ...
        <div className="col span-1-of-4 box">
            <i className="ion-android-cart icon-big"></i>
